...
// GET /api/admin/academy/collections/[id]
...
// PUT /api/admin/academy/collections/[id]
export async function PUT(
  ...
  try {
    ...
    const collection = await prisma.academyCollection.update({
      where: { id: params.id },
      data: validated,
    })
    ...
    console.error('Error updating academy collection:', error)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}

// DELETE /api/admin/academy/collections/[id]
export async function DELETE(
  ...
  try {
    ...
    await prisma.academyCollection.delete({
      where: { id: params.id },
    })

    return NextResponse.json({ success: true })
  } catch (error) {
    console.error('Error deleting academy collection:', error)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}
