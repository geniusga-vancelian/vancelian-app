...
// GET /api/admin/academy/categories/[id]
...
// PUT /api/admin/academy/categories/[id]
...
// DELETE /api/admin/academy/categories/[id]
export async function DELETE(
  ...
  try {
    ...
    if (category._count.unifiedArticles > 0) {
      return NextResponse.json(
    ...
    await prisma.academyCategory.delete({
      where: { id: params.id },
    })
