...
export async function POST(request: NextRequest) {
  try {
    ...
    const backendUrl = buildBackendUrl('/api/market-data/update-daily')

    if (process.env.NODE_ENV === 'development') {
      console.log('[Market Data Update Daily] Backend URL:', backendUrl)
    }
    ...
    try {
      ...
      console.error('[Market Data Update Daily] Backend proxy error:', {
    ...
    console.error('Market Data update-daily error:', error)
