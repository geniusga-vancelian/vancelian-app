...
/** Confirme les receipts on-chain et met à jour le ledger Ledgity. */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[api/portal/ledgity/confirm POST]', error)
    return NextResponse.json({ code: 'ledgity.confirm_failed', message: 'Erreur interne.' }, { status: 500 })
  }
}
