...
export const PORTAL_MAIN_NAV_TABS: PortalNavTab[] = [
  { id: 'home', label: 'Home', href: PORTAL_ROUTES.dashboard, icon: Home },
  { id: 'invest', label: 'Invest', href: PORTAL_ROUTES.invest, icon: TrendingUp },
  { id: 'markets', label: 'Markets', href: PORTAL_ROUTES.markets, icon: Bitcoin },
  { id: 'design', label: 'Design', href: PORTAL_ROUTES.design, icon: Radio },
]
