...
class AcademyArticlesScreen extends StatefulWidget {
  const AcademyArticlesScreen({
    super.key,
  ...
  @override
  State<AcademyArticlesScreen> createState() => _AcademyArticlesScreenState();
}

class _AcademyArticlesScreenState extends State<AcademyArticlesScreen> {
  final AcademyApi _api = AcademyApi();
  final TextEditingController _searchController = TextEditingController();
  String _selectedTagKey = 'ALL';
  bool _loading = true;
  String? _error;
  List<AcademyArticleItem> _articles = const [];
  ...
  List<AcademyArticleItem> get _filtered {
  ...
  List<AcademyTargetTag> get _availableTags {
    final byKey = <String, AcademyTargetTag>{};
  ...
  Widget _buildBody() {
    ...
    return Column(
      ...
      children: [
        ...
        AcademyChevronCardList(
          items: _filtered
              .map(
                (a) => AcademyChevronCardItem(
                  title: a.question,
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute<void>(
                        builder: (_) => ArticleDetailScreen.academy(
                          collectionSlug: widget.collectionSlug,
                          categorySlug: widget.categorySlug,
                          articleSlug: a.slug,
                        ),
