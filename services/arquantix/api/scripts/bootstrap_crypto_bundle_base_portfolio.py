...
1. CRYPTO_BUNDLE_TWO_KINGS — Bitcoin 70% / Ethereum 30% (cbBTC + ETH on Base)
...
BUNDLES: tuple[dict, ...] = (
    {
        ...
        "description": (
            ...
            "allocation, while Ethereum accounts for the remaining 30%. "
        ...
        "template_description": "70% Bitcoin (cbBTC) / 30% Ethereum.",
        "sort_hint": 10,
        "allocations": [
    ...
    },
    {
        ...
        "description": (
            ...
            "available on Base. The target allocation is 50% Bitcoin (cbBTC), 30% Ethereum, and 20% split equally "
        ...
        "template_description": "50% Bitcoin / 30% Ethereum / ~6.7% each on Chainlink, Aave, Uniswap.",
        "sort_hint": 20,
        "allocations": [
