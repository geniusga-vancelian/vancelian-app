...
def tick_bundle_v3_deposit_worker(
    ...
    *,
    ...
    if not bundle_v3_deposit_worker_enabled():
        return BundleV3DepositWorkerTickResult(processed=0, failed=0, skipped=True)
    ...
    return BundleV3DepositWorkerTickResult(processed=processed, failed=failed, skipped=False)
