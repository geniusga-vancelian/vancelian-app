"""add_market_data_bars_5m

Revision ID: 016
Revises: 015
Create Date: 2026-02-18

Intraday 5-minute candle table for Binance crypto instruments.
"""
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_market_data_bars_5m_instrument_id"),
        "market_data_bars_5m",
        ["instrument_id"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_market_data_bars_5m_open_time"),
        "market_data_bars_5m",
        ["open_time"],
        unique=False,
        schema="public",
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_market_data_bars_5m_open_time"),
        table_name="market_data_bars_5m",
        schema="public",
    )
    op.drop_index(
        op.f("ix_market_data_bars_5m_instrument_id"),
    ...
    op.drop_table("market_data_bars_5m", schema="public")
