"""add_market_data_bars_1w

Revision ID: 020
Revises: 019
Create Date: 2026-02-18

1-week candle table for Binance crypto instruments.
"""
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_market_data_bars_1w_instrument_id"),
        "market_data_bars_1w",
        ["instrument_id"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_market_data_bars_1w_open_time"),
        "market_data_bars_1w",
        ["open_time"],
        unique=False,
        schema="public",
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_market_data_bars_1w_open_time"),
        table_name="market_data_bars_1w",
        schema="public",
    )
    op.drop_index(
        op.f("ix_market_data_bars_1w_instrument_id"),
    ...
    op.drop_table("market_data_bars_1w", schema="public")
