"""add_market_data_bars_1m

Revision ID: 065
Revises: 064
Create Date: 2026-03-15

Intraday 1-minute candle table for Binance crypto instruments.
Retention: ~7-14 days of data. Used for wallet history chart (0-2h granularity).
"""
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_market_data_bars_1m_instrument_id"),
        "market_data_bars_1m",
        ["instrument_id"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_market_data_bars_1m_open_time"),
        "market_data_bars_1m",
        ["open_time"],
        unique=False,
        schema="public",
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_market_data_bars_1m_open_time"),
        table_name="market_data_bars_1m",
        schema="public",
    )
    op.drop_index(
        op.f("ix_market_data_bars_1m_instrument_id"),
    ...
    op.drop_table("market_data_bars_1m", schema="public")
