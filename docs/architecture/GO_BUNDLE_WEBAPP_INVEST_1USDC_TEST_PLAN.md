...
| Champ | Valeur |
| --- | --- |
| **Statut** | **NON EXÉCUTÉ — en attente Go explicite** |
...
- [ ] Baseline prod : PE=19 · CB=67 · legs=131 · locks=0 · dead_letter=0
- [ ] Tous flags Bundle OFF en TD ECS
- [ ] USDC disponible wallet pilote ≥ 1 USDC (+ buffer gas)
...
2. Baseline ECS script
3. Invest WebApp manuel supervisé (gaelitier)
4. Audit post-trade ECS (parent/child/swap/PE)
5. Rapport `GO_BUNDLE_WEBAPP_INVEST_1USDC_TEST_REPORT.md`
