...
MORPHO_USDC_BETA_MAX_GLOBAL_EXPOSURE_USDC="${MORPHO_USDC_BETA_MAX_GLOBAL_EXPOSURE_USDC:-10000}"
MORPHO_USDC_MIN_DEPOSIT_RAW="${MORPHO_USDC_MIN_DEPOSIT_RAW:-10000000}"
MORPHO_USDC_MAX_DEPOSIT_RAW="${MORPHO_USDC_MAX_DEPOSIT_RAW:-100000000}"
MORPHO_USDC_MAX_USER_EXPOSURE_RAW="${MORPHO_USDC_MAX_USER_EXPOSURE_RAW:-500000000}"
MORPHO_USDC_MAX_GLOBAL_EXPOSURE_RAW="${MORPHO_USDC_MAX_GLOBAL_EXPOSURE_RAW:-10000000000}"
